...
require("gruvbox").setup({
  ...
  overrides = {
    ...
    TelescopePromptBorder      = { fg = colors.gray, bg = colors.bg },
    TelescopeResultsBorder     = { fg = colors.gray, bg = colors.bg },
    TelescopePreviewBorder     = { fg = colors.gray, bg = colors.bg },
    TelescopeSelection         = { fg = colors.magenta, bg = colors.black },
    TelescopeSelectionCaret    = { fg = colors.red, bg = colors.black },
    -- code
