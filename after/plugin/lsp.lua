...
nmap("<leader>ls", "<cmd>LspInfo<cr>", "info")
nmap("<leader>li", "<cmd>LspInstall<cr>", "install")
nmap("<leader>ll", "<cmd>LspLog<cr>", "log")
nmap("<leader>lr", "<cmd>LspRestart<cr>", "restart")
nmap("<leader>la", "<cmd>LspStart<cr>", "start")
nmap("<leader>lo", "<cmd>LspStop<cr>", "stop")
nmap("<leader>lu", "<cmd>LspUninstall<cr>", "uninstall")
nmap("<leader>lf", "<cmd>LspFormatToggle<cr>", "format toggle")
